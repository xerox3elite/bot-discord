...
class CommunityCommands(commands.Cog):
    ...
    @app_commands.command(name="community_top_messages", description="💬 Classement des messages avec analyses")
    ...
    @app_commands.command(name="community_version", description="🚀 Informations détaillées sur la version")
    ...
    @app_commands.command(name="community_bugreport", description="🐛 Système de rapport de bugs avancé")
    @app_commands.describe(
